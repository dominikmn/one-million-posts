...
def create_splits():
    ...
    features_strat = ['label_argumentsused', 'label_discriminating', 'label_inappropriate',
       'label_offtopic', 'label_personalstories', 'label_possiblyfeedback',
       'label_sentimentnegative', 'label_sentimentneutral',
    ...
    ann2_train, ann2_val = train_test_split(ann2_train, stratify=df_ann2[features_strat],random_state=RSEED, test_size=100)

    ann3_train, ann3_test = train_test_split(df_ann3, stratify=df_ann3[features_strat],random_state=RSEED, test_size=0.25)
    ann3_train, ann3_val = train_test_split(ann3_train, stratify=df_ann3[features_strat],random_state=RSEED, test_size=0.13)
